...
public class MJpegI18n {
  ...
  public static final String PREVIEW_MENU="PreviewMenu"; //Preview
  public static final String PREVIEW_MENU__FILM_MENU_ITEM="PreviewMenu.FilmMenuItem"; //Film
  public static final String PREVIEW_MENU__PICTURE_MENU_ITEM="PreviewMenu.PictureMenuItem"; //Picture
